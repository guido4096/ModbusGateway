...
{
    static DeviceDescription<EM24> dd = DeviceDescription<EM24>::makeDD("em24",
        std::vector<BlockDefinition<EM24>>{
            BlockDefinition<EM24>{"dynamic", 0x0000,
                                  std::vector<RegisterDefinition<EM24>>{
            ...
            BlockDefinition<EM24>{"energy", 0x0034, 
                                  std::vector<RegisterDefinition<EM24>>{
            ...
            BlockDefinition<EM24>{"time", 0x005a,
                                  std::vector<RegisterDefinition<EM24>>{
                                      {hour, DataType::int32, "Hour", "hour", Scaling::hundred, Value::_int32_t(0)},
                                  }},
            BlockDefinition<EM24>{"tariff", 0x006e,
                                  std::vector<RegisterDefinition<EM24>>{
